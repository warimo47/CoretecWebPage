...
<div id="subvisual" style="background:url(./img/sv_02.jpg);">
	...
	<div class="sub_tab">
		<a href="<?php echo G5_URL;?>./sub_04_01.php" <?php if ($pcode == '01') { ?>class="tab_on"<?php }?>>VR-miniature</a>
		<a href="<?php echo G5_URL;?>./sub_04_02.php" <?php if ($pcode == '02') { ?>class="tab_on"<?php }?>>AR-miniature</a>
		<a href="<?php echo G5_URL;?>./sub_04_03.php" <?php if ($pcode == '03') { ?>class="tab_on"<?php }?>>빌프레(BuilPre)</a>
		<!--
